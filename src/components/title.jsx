...
const title = ({ children }) => {
  return (
    ...
    // </div>
    <h1 className='text-center p-4 font-semibold text-6xl md:text-8xl bg-gradient-to-r from-white to-purple-200 bg-clip-text animate-[shine_2s_infinite] [mask-image:linear-gradient(-75deg,rgba(0,0,0,0.8)_30%,#000_50%,rgba(0,0,0,0.8)_70%)] [mask-size:200%] text-transparent cursor-default'>
      {children}
    </h1>
