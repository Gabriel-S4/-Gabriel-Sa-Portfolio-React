...
function purpleTransition() {
    return (
        ...
        <>
            <section className='relative w-full p-[30px] flex flex-col justify-center items-center gap-10 before:absolute before:z-4 before:top-0 before:left-0 before:w-full before:h-60 before:bg-gradient-to-t before:from-transparent before:to-(--purple-dark-dark)'>
                {/* container Services */}
...
export default purpleTransition
